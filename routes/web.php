...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // RUTE BARU: Untuk menyimpan Rating (CSAT)
    Route::post('/pengaduan/{id}/rate', [ComplaintController::class, 'rate'])->name('complaint.rate');
    
    Route::get('/notifikasi', [DashboardController::class, 'notifications'])->name('notifications.index');
});

// --- RUTE PANEL MANAJEMEN (ADMIN & SUPER ADMIN) ---
