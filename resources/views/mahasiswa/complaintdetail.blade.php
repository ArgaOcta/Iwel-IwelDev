...
@php
    // Logika Warna Badge Status Dinamis
...
<div class="w-full max-w-7xl mx-auto pt-6 pb-14 px-4 sm:px-6 lg:px-8 relative">
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
        ...
        <button onclick="window.print()" class="bg-white rounded-lg border border-[#c3c6d7] px-4 py-2 text-[#191b23] font-['Manrope-SemiBold',_sans-serif] text-[13px] font-semibold tracking-[0.65px] shadow-[0_1px_2px_rgba(0,0,0,0.05)] hover:bg-gray-50 transition shrink-0">
            Print Report
        </button>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-8 flex flex-col gap-6">
            ...
            <div class="bg-white rounded-xl border border-[rgba(195,198,215,0.30)] p-6 shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
                <div class="border-b border-[rgba(195,198,215,0.30)] pb-3 mb-4 flex items-center gap-2">
                    ...
                    <h2 class="text-[#191b23] font-['Manrope-SemiBold',_sans-serif] text-lg font-semibold">Informasi Laporan</h2>
                </div>

                <div class="flex flex-col gap-5">
                    <div class="flex flex-col gap-1">
                        <label class="text-[#434655] font-semibold text-[13px] tracking-[0.65px]">Kategori</label>
                        <p class="text-[#191b23] text-base">{{ $complaint->category->name ?? 'Kategori Umum' }}</p>
                    </div>
                    
                    <div class="flex flex-col gap-1">
                        <label class="text-[#434655] font-semibold text-[13px] tracking-[0.65px]">Deskripsi Lengkap</label>
            ...
            <div class="bg-white rounded-xl border border-[rgba(195,198,215,0.30)] p-6 shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
                <div class="flex items-center gap-2 mb-4">
                    <svg width="13" height="20" viewBox="0 0 13 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12.5 13.75C12.5 15.4833 11.8917 16.9583 10.675 18.175C9.45833 19.3917 7.98333 20 6.25 20C4.51667 20 3.04167 19.3917 1.825 18.175C0.608333 16.9583 0 15.4833 0 13.75V4.5C0 3.25 0.4375 2.1875 1.3125 1.3125C2.1875 0.4375 3.25 0 4.5 0C5.75 0 6.8125 0.4375 7.6875 1.3125C8.5625 2.1875 9 3.25 9 4.5V13.25C9 14.0167 8.73333 14.6667 8.2 15.2C7.66667 15.7333 7.01667 16 6.25 16C5.48333 16 4.83333 15.7333 4.3 15.2C3.76667 14.6667 3.5 14.0167 3.5 13.25V4H5.5V13.25C5.5 13.4667 5.57083 13.6458 5.7125 13.7875C5.85417 13.9292 6.03333 14 6.25 14C6.46667 14 6.64583 13.9292 6.7875 13.7875C6.92917 13.6458 7 13.4667 7 13.25V4.5C6.98333 3.8 6.7375 3.20833 6.2625 2.725C5.7875 2.24167 5.2 2 4.5 2C3.8 2 3.20833 2.24167 2.725 2.725C2.24167 3.20833 2 3.8 2 4.5V13.75C1.98333 14.9333 2.39167 15.9375 3.225 16.7625C4.05833 17.5875 5.06667 18 6.25 18C7.41667 18 8.40833 17.5875 9.225 16.7625C10.0417 15.9375 10.4667 14.9333 10.5 13.75V4H12.5V13.75Z" fill="#004AC6"/></svg>
                    <h2 class="text-[#191b23] font-['Manrope-SemiBold',_sans-serif] text-lg font-semibold">Bukti Lampiran</h2>
                </div>
                        ...
                        @else
                            <div class="bg-[#ededf9] rounded-lg border border-[rgba(195,198,215,0.30)] flex items-center justify-center relative aspect-video p-4 text-center">
                                <a href="{{ asset('storage/' . $attachment->file_path) }}" target="_blank" class="text-[#004ac6] text-sm font-semibold hover:underline flex flex-col items-center gap-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14 2H6C4.9 2 4 2.9 4 4V20C4 21.1 4.9 22 6 22H18C19.1 22 20 21.1 20 20V8L14 2ZM13 9V3.5L18.5 9H13Z" fill="currentColor"/></svg>
            ...
            <div class="bg-white rounded-xl border border-[rgba(195,198,215,0.30)] flex flex-col h-[500px] shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
                <div class="bg-[#faf8ff] rounded-t-xl border-b border-[rgba(195,198,215,0.30)] p-4 flex justify-between items-center shrink-0">
                    <div class="flex items-center gap-2">
                        ...
                        <h2 class="text-[#191b23] font-['Manrope-SemiBold',_sans-serif] text-lg font-semibold">Diskusi & Tanggapan</h2>
                    </div>
                </div>
                ...
                <div class="bg-[#faf8ff] flex-1 p-4 overflow-y-auto flex flex-col gap-4 relative">
                    <div class="text-center mb-4">
                        <span class="bg-[#ededf9] text-[#434655] text-[11px] font-semibold px-3 py-1 rounded-full uppercase tracking-wider">
                            LAPORAN DIBUAT - {{ $complaint->created_at->format('d M, h:i A') }}
                        </span>
                    </div>

                    <div class="flex flex-row gap-2 items-end justify-end self-end max-w-[85%]">
                        <div class="bg-[#2563eb] rounded-tl-2xl rounded-tr-2xl rounded-br-sm rounded-bl-2xl p-3 flex flex-col gap-1 shadow-sm text-white text-base">
                            <div>Laporan awal berhasil dikirim ke sistem.</div>
                            <div class="text-[rgba(255,255,255,0.70)] text-xs text-right">{{ $complaint->created_at->format('h:i A') }}</div>
                        </div>
                        <div class="w-8 h-8 rounded-full bg-[#004ac6] flex items-center justify-center text-white font-bold text-xs shrink-0 shadow-sm">
                            ME
                        </div>
                    </div>
                    
                    @if($complaint->status != 'Pending')
                    <div class="flex flex-row gap-2 items-end justify-start self-start max-w-[85%] mt-4">
                        <div class="w-8 h-8 rounded-full bg-[#505f76] flex items-center justify-center text-white font-bold text-xs shrink-0 shadow-sm border border-gray-200">
                            AD
                        </div>
                        <div class="bg-[#e1e2ed] rounded-tl-2xl rounded-tr-2xl rounded-br-2xl rounded-bl-sm border border-[rgba(195,198,215,0.30)] p-3 flex flex-col gap-1 shadow-sm">
                            <div class="text-[#004ac6] font-semibold text-[13px] tracking-wide">{{ $complaint->category->department ?? 'Admin Sistem' }}</div>
                            <div class="text-[#191b23] text-base">Laporan Anda sedang dalam proses penanganan oleh staf kami.</div>
                            <div class="text-[#434655] text-xs mt-1">{{ $complaint->updated_at->format('h:i A') }}</div>
                        </div>
                    </div>
                    @endif
                </div>

                <div class="bg-[#ffffff] rounded-b-xl border-t border-[rgba(195,198,215,0.30)] p-4 flex items-center gap-3 shrink-0">
                    <input type="text" placeholder="Tulis pesan atau tanggapan..." class="flex-1 bg-[#f3f3fe] rounded-xl border border-[#c3c6d7] px-4 py-3 text-[#191b23] focus:outline-none focus:border-[#004ac6]" disabled>
                    <button type="button" class="bg-[#004ac6] w-12 h-12 rounded-xl flex items-center justify-center hover:bg-blue-800 transition shadow-sm opacity-50 cursor-not-allowed">
                        <svg width="16" height="14" viewBox="0 0 16 14" fill="none"><path d="M0 13.3333V0L15.8333 6.66667L0 13.3333ZM1.66667 10.8333L11.5417 6.66667L1.66667 2.5V5.41667L6.66667 6.66667L1.66667 7.91667V10.8333ZM1.66667 10.8333V6.66667V2.5V5.41667V7.91667V10.8333Z" fill="white"/></svg>
                    </button>
                </div>
            </div>
        ...
        <div class="lg:col-span-4 flex flex-col gap-6">
            ...
            <div class="bg-white rounded-xl border border-[rgba(195,198,215,0.30)] p-6 shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
                <h3 class="text-[#191b23] font-['Manrope-SemiBold',_sans-serif] text-lg font-semibold border-b border-[rgba(195,198,215,0.30)] pb-3 mb-4">Ringkasan</h3>
                
                <div class="flex flex-col gap-4">
                    <div class="flex justify-between items-center">
                        <span class="text-[#434655] font-semibold text-[13px] tracking-[0.65px]">Tanggal Dibuat</span>
                        <span class="text-[#191b23] text-sm font-medium">{{ $complaint->created_at->format('d M Y, H:i') }}</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-[#434655] font-semibold text-[13px] tracking-[0.65px]">Tingkat Urgensi</span>
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-[#434655] font-semibold text-[13px] tracking-[0.65px]">Ditugaskan Ke</span>
                        <span class="text-[#191b23] text-sm font-medium text-right max-w-[150px]">{{ $complaint->category->department ?? 'Sistem' }}</span>
                    </div>
                    <div class="flex justify-between items-center border-t border-[rgba(195,198,215,0.20)] pt-3 mt-1">
                        <span class="text-[#434655] font-semibold text-[13px] tracking-[0.65px]">Terakhir Diperbarui</span>
                        <span class="text-[#191b23] text-sm font-medium">{{ $complaint->updated_at->diffForHumans() }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl border border-[rgba(195,198,215,0.30)] p-6 shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
                <div class="flex items-center gap-2 mb-6">
                    ...
                    <h2 class="text-[#191b23] font-['Manrope-SemiBold',_sans-serif] text-lg font-semibold">Status Laporan</h2>
                </div>
                ...
                <div class="relative pl-3 flex flex-col gap-8">
                    ...
                    <div class="flex gap-4 relative z-10">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <span class="text-[#434655] text-[11px]">{{ $complaint->created_at->format('d M, H:i') }}</span>
                        </div>
                    </div>

                    <div class="flex gap-4 relative z-10 {{ $complaint->status == 'Pending' ? 'opacity-50' : '' }}">
                        <div class="{{ $complaint->status != 'Pending' ? 'bg-[#004ac6]' : 'bg-[#e1e2ed] border-2 border-[#c3c6d7]' }} w-8 h-8 rounded-full flex items-center justify-center shrink-0 shadow-[0_0_0_4px_white]">
                            @if($complaint->status != 'Pending')
                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M10.6125 13.275L6.075 8.7C5.825 8.8 5.57188 8.875 5.31563 8.925C5.05938 8.975 4.7875 9 4.5 9C3.25 9 2.1875 8.5625 1.3125 7.6875C0.4375 6.8125 0 5.75 0 4.5C0 4.05 0.0625 3.62188 0.1875 3.21563C0.3125 2.80938 0.4875 2.425 0.7125 2.0625L3.45 4.8L4.8 3.45L2.0625 0.7125C2.425 0.4875 2.80938 0.3125 3.21563 0.1875C3.62188 0.0625 4.05 0 4.5 0C5.75 0 6.8125 0.4375 7.6875 1.3125C8.5625 2.1875 9 3.25 9 4.5C9 4.7875 8.975 5.05938 8.925 5.31563C8.875 5.57188 8.8 5.825 8.7 6.075L13.275 10.6125C13.425 10.7625 13.5 10.9438 13.5 11.1562C13.5 11.3687 13.425 11.55 13.275 11.7L11.7 13.275C11.55 13.425 11.3687 13.5 11.1562 13.5C10.9438 13.5 10.7625 13.425 10.6125 13.275Z" fill="white"/></svg>
                            @endif
                        </div>
                        <div class="flex flex-col gap-1">
                            <h4 class="{{ $complaint->status != 'Pending' ? 'text-[#004ac6]' : 'text-[#434655]' }} font-bold text-lg">Sedang Diproses</h4>
                            <p class="text-[#191b23] text-sm">Admin sedang menangani laporan.</p>
                            @if($complaint->status != 'Pending')
                                <span class="text-[#004ac6] text-[11px]">{{ $complaint->updated_at->format('d M, H:i') }} (Latest)</span>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4 relative z-10 {{ in_array($complaint->status, ['Resolved', 'Closed']) ? '' : 'opacity-40' }}">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <p class="text-[#434655] text-sm">
                                {{ in_array($complaint->status, ['Resolved', 'Closed']) ? 'Laporan telah diselesaikan.' : 'Menunggu konfirmasi perbaikan.' }}
                            </p>
                        </div>
                    </div>
