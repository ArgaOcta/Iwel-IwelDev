    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-4 flex flex-col gap-6">
            ...
            <div class="bg-[rgba(255,255,255,0.90)] backdrop-blur-sm rounded-xl border border-[rgba(195,198,215,0.30)] shadow-[0_4px_20px_rgba(0,0,0,0.04)] overflow-hidden flex flex-col relative pb-6">
                ...
                <div class="pt-[84px] flex flex-col items-center gap-1.5 px-6">
                    ...
                    <div class="bg-[#ededf9] rounded-full px-3 py-1">
                        <span class="text-[#434655] font-['Manrope-Regular',_sans-serif] text-sm leading-5">Computer Science Student</span>
                    </div>
                </div>
                ...
                <div class="mx-6 mt-6 pt-4 border-t border-[rgba(195,198,215,0.40)] flex flex-col gap-3">
                    ...
                    <div class="flex justify-between items-center w-full">
                        ...
                        <span class="text-[#191b23] font-['Manrope-Medium',_sans-serif] text-sm font-medium">{{ Auth::user()->created_at->format('M Y') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl border border-[rgba(195,198,215,0.30)] p-6 shadow-[0_4px_20px_rgba(0,0,0,0.04)] flex flex-col gap-4">
                ...
                <a href="#" class="rounded-lg p-3 flex gap-3 items-center hover:bg-gray-50 transition group border border-transparent hover:border-gray-200">
                    <div class="bg-[rgba(0,74,198,0.10)] group-hover:bg-[#004ac6] transition-colors rounded w-8 h-8 flex items-center justify-center shrink-0">
                    ...
                    <div class="flex flex-col flex-1">
                        <span class="text-[#191b23] font-['Manrope-Medium',_sans-serif] text-sm font-medium">Contact Administrator</span>
                        <span class="text-[#434655] font-['Manrope-Regular',_sans-serif] text-sm">Direct messaging system</span>
                    </div>
                </a>
            </div>
        </div>
        ...
        <div class="lg:col-span-8 flex flex-col gap-6">
            ...
            <div class="bg-white rounded-xl border border-[rgba(195,198,215,0.30)] shadow-[0_4px_20px_rgba(0,0,0,0.04)]">
                <div class="border-b border-[rgba(195,198,215,0.30)] bg-[rgba(243,243,254,0.50)] rounded-t-xl p-4 px-6 flex justify-between items-center">
                    ...
                    <button class="flex items-center gap-1.5 text-[#004ac6] text-[13px] font-semibold tracking-[0.65px] hover:bg-blue-50 px-3 py-1.5 rounded transition">
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M1.5 12H2.56875L9.9 4.66875L8.83125 3.6L1.5 10.9312V12ZM0 13.5V10.3125L9.9 0.43125C10.05 0.29375 10.2156 0.1875 10.3969 0.1125C10.5781 0.0375 10.7688 0 10.9688 0C11.1687 0 11.3625 0.0375 11.55 0.1125C11.7375 0.1875 11.9 0.3 12.0375 0.45L13.0688 1.5C13.2188 1.6375 13.3281 1.8 13.3969 1.9875C13.4656 2.175 13.5 2.3625 13.5 2.55C13.5 2.75 13.4656 2.94062 13.3969 3.12188C13.3281 3.30313 13.2188 3.46875 13.0688 3.61875L3.1875 13.5H0ZM12 2.55L10.95 1.5L12 2.55ZM9.35625 4.14375L8.83125 3.6L9.9 4.66875L9.35625 4.14375Z" fill="#004AC6"/></svg>
                        Edit
                    </button>
                </div>
                ...
                <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col gap-2">
                        <label class="text-[#434655] text-[13px] font-semibold tracking-[0.65px]">Student ID (NIM)</label>
                        <div class="bg-[#e7e7f3] opacity-80 rounded-lg border border-[rgba(195,198,215,0.50)] p-3 pl-10 relative">
                            ...
                            <div class="text-[#434655] text-base">{{ Auth::user()->nim ?? 'Not Registered' }}</div>
                        </div>
                        <p class="text-[#737686] text-[12px] mt-1 italic">NIM cannot be changed directly.</p>
                    </div>

                    <div class="flex flex-col gap-2">
                        <label class="text-[#434655] text-[13px] font-semibold tracking-[0.65px]">Major / Program</label>
                        <div class="bg-[#faf8ff] rounded-lg border border-[#c3c6d7] p-3 pl-10 relative">
                            ...
                            <div class="text-[#191b23] text-base">Computer Science</div>
                        </div>
                    </div>

                    <div class="flex flex-col gap-2">
                        <label class="text-[#434655] text-[13px] font-semibold tracking-[0.65px]">University Email</label>
                        <div class="bg-[#faf8ff] rounded-lg border border-[#c3c6d7] p-3 pl-10 relative">
            ...
            <div class="bg-white rounded-xl border border-[rgba(195,198,215,0.30)] shadow-[0_4px_20px_rgba(0,0,0,0.04)]">
                <div class="border-b border-[rgba(195,198,215,0.30)] bg-[rgba(243,243,254,0.50)] rounded-t-xl p-4 px-6 flex items-center gap-2">
                ...
                <form method="post" action="{{ route('password.update') }}" class="p-6 flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex gap-1 mt-1">
                            <div class="h-1 flex-1 rounded-full bg-[#004ac6]"></div>
                            <div class="h-1 flex-1 rounded-full bg-[#004ac6]"></div>
                            <div class="h-1 flex-1 rounded-full bg-[#e1e2ed]"></div>
                            <div class="h-1 flex-1 rounded-full bg-[#e1e2ed]"></div>
                        </div>
                        <span class="text-[#737686] text-sm">Password strength: Fair</span>
