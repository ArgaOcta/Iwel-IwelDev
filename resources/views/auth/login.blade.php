                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="w-full rounded-lg border border-[#C3C6D7] bg-white py-[13px] pl-10 pr-3 text-base text-[#191B23] placeholder:text-[#C3C6D7] focus:border-[#004AC6] focus:outline-none focus:ring-2 focus:ring-[#004AC6]/20 @error('password') border-red-500 focus:border-red-500 focus:ring-red-500/20 @enderror"
                            >
                        </div>
                        @error('password')
                            <p class="text-sm leading-5 text-red-600">{{ $message }}</p>
